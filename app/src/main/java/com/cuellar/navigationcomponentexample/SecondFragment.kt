...
import com.cuellar.navigationcomponentexample.audio.AppDatabase
import com.cuellar.navigationcomponentexample.audio.AudioPlayerActivity
import com.cuellar.navigationcomponentexample.audio.AudioRecord
import com.cuellar.navigationcomponentexample.audio.GalleryActivity
import com.cuellar.navigationcomponentexample.audio.Timer
import com.cuellar.navigationcomponentexample.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment(), Timer.OnTimerTickListener{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val name = args.name
        binding.tvName.text = name // Usa binding para acceder al TextView
    ...
    private fun save(){
        ...
        if (newfilename != fileName) {
            ...
            fileName = newfilename // Actualizamos el nombre del archivo
        }
        ...
        // Guardar las amplitudes en un archivo
        try {
        ...
        // Aquí iniciamos la actividad para reproducir el audio recién guardado
