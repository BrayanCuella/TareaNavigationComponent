...
import com.cuellar.navigationcomponentexample.AdaptadorListener
import com.cuellar.navigationcomponentexample.AdaptadorUsuarios
import com.cuellar.navigationcomponentexample.DBPrueba
import com.cuellar.navigationcomponentexample.Usuario
import com.cuellar.navigationcomponentexample.databinding.FragmentFourBinding
import kotlinx.coroutines.launch

class fourFragment: Fragment(), AdaptadorListener{
    ...
    fun obtenerUsuarios(room: DBPrueba){
        lifecycleScope.launch {
            ...
            adapter = AdaptadorUsuarios(listaUsuarios, this@fourFragment)
